    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <div className="px-6 pt-4 pb-2 text-center">
                ...
                <p className="text-gray-400 text-base mt-1">망양 응달기와집(응달재집) 후손들입니다.</p>
                <p className="text-gray-400 text-base mt-1">망양정이 최초에 이 동산에 있었다 합니다.</p>
            </div>

            {/* 하단 PIN 입력 */}
            <div className="flex-1 flex flex-col items-center justify-center px-8 py-10">
                <h1 className="text-2xl font-bold text-gray-800 mb-1">망양 모임</h1>
                <p className="text-gray-400 text-base mb-8">PIN 번호를 입력하세요</p>
                ...
                {error && (
                    <p className="text-red-500 text-base mb-3">PIN이 올바르지 않습니다</p>
                )}
